...
class Client extends Model
{
    ...
    protected $fillable = ['desk_id','name','parentage','dob','education','gender','phone_primary','phone_secondary','cnic','monthly_income','address','province','district','medical_expense','phone_verified','status'];
