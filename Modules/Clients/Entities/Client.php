...
class Client extends Model
{
    ...
    protected $fillable = ['desk_id','name','parentage','dob','education','gender','weight','height','blood_group','marital_status','relation','phone_primary','phone_secondary','cnic','email','monthly_income','address','province','district','medical_expense','phone_verified','status'];
