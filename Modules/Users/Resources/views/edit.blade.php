        ...
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-md-4 form-group">
              ...
              <input type="text" class="form-control" value="{{$data['user']->bank_name}}" name="bank_name" placeholder="Bank Account Name">
            </div>
            <div class="col-md-4 form-group">
              <label>Bank Account Title</label>
              <input type="text" class="form-control" value="{{$data['user']->bank_account_title}}" name="bank_account_title" placeholder="Bank Account Title">
            </div>
            <div class="col-md-4 form-group">
              <label>Bank Account No</label>
              <input type="text" class="form-control" value="{{$data['user']->bank_account_no}}" name="bank_account_no" placeholder="Bank Account No">
            </div>
          </div>
