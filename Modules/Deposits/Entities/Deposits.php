...
class Deposits extends Model
{
    ...
    protected $fillable = ['client_subscription_ids','user_id','desk_id','amount','due_compensation','paid_compensation','pending_compensation','desposit_date','deposit_slip','deposit_slip_no','bank_id','is_verified'];
