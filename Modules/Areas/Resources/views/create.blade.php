...
<form action="{{url('areas/store')}}" method="post" enctype="multipart/form-data">
  @csrf
  <div class="row">
        ...
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="form-group col-md-6">
              ...
              <select name="region_id" class="form-control select2 @error('region_id') is-invalid @enderror" >
